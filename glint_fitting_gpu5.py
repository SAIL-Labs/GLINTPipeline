...
from glint_fitting_config5 import config
...
nb_files_data = (2500, 3000) #(20782, None) # Which data files to load
nb_files_dark = (0, 1000) # Which dark files to load
basin_hopping_nloop = (30, 31) # lower and upper bound of the iteration loop for basin hopping method
...
mu_opd0 = config['mu_opd0'] # initial guess of DeltaPhi mu
sig_opd0 = config['sig_opd0'] # initial guess of DeltaPhi sig
na0 = config['na0'] # initial guess of astro null
...
#        IB = injection[1][None,:] * spectra[1][:,None]
    ...
    if activate_time_binning_photometry:
        if nb_frames_binning < 0:
            ...
            injection = gff.binning(injection, nb_frames_binning, axis=1, avg=True)
            injection_dark = gff.binning(injection_dark, nb_frames_binning, axis=1, avg=True)
